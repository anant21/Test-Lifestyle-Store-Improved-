                        ...
                        if (mysqli_num_rows($result) >= 1) {
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    $sum+= $row["Price"];
                                    $id .= $row["pid"] . ", ";
                                    echo "<tr><td>" . "#" . $row["pid"] . "</td><td><b>" . $row["Name"] . "</b></td><td>Rs " . $row["Price"] . "</td><td>". $row["timestamp"] ."
                                    </td><td><a href='cart-remove.php?id={$row['pid']}' class='btn btn-danger' ><span class='glyphicon glyphicon-remove'></span> Remove</a></td></tr>";
                                }
                                echo "<tr><td></td><td><b>Total</b></td><td><b>Rs " . $sum . "</td><td></td><td><a href='success.php?id=" . $id . "' class='btn btn-success'>
